...
const FriendRequestsSidebar = ({
  ...
  return (
    <>
      ...
      >
        <section className="flex h-6 w-6 shrink-0 items-center justify-center rounded-lg border bg-slate-200 text-[0.625rem] font-medium text-slate-900 group-hover:border-blue-400 group-hover:text-blue-400">
